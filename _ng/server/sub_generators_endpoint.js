...
exports.EndpointSubGenerator = class EndpointSubGenerator {
  constructor(generator) {
    ...
    this.wrapper.webFrameworkNodeServer = this.wrapper.config.get('webFrameworkNodeServer');
    this.wrapper.webFrameworkGoServer = this.wrapper.config.get('webFrameworkGoServer');
  }
